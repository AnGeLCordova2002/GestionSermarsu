                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="composeModalLabel">Redactar mensaje</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <form>
                                                        <label for="composeEmailTo" class="form-label">Ingresar Correo</label>
                                                    ...
                                                    <ul class="list-unstyled">
                                                        ...
                                                        <li class="mailbox-list-item">
                                                            <a href="#" id="<?php echo $archivo['id']; ?>" class="compartidos">
                                                                ...
                                                                <img src="<?php echo BASE_URL . 'Assets/images/LOGO_SERMARSU.png'; ?>" alt="">

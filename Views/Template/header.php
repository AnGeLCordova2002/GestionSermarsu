...
<body>
    <div class="app align-content-stretch d-flex flex-wrap">
        <div class="app-sidebar">
            <div class="logo">
                <a href="#" class="logo-icon"><span class="logo-text">ACTIVO</span></a>
            ...
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li class="active-page">
                        <a href="<?php echo BASE_URL . 'usuarios'; ?>" class="active"><i class="material-icons">
                            people_alt
                        </i>Usuarios</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="<?php echo BASE_URL . 'admin'; ?>"><i class="material-icons-two-tone">cloud_queue</i>Gestion Archivos</a>
                    </li>
                </ul>
            </div>
        </div>
